...
KERNEL_DEVICETREE_ti33x = "am335x-st7b2.dtb"
COMPATIBLE_MACHINE = "ti33x|ti43x|omap-a15|omap3|omap4|keystone"

S = "${WORKDIR}/git"

BRANCH = "tailyn_ti_4.4.19+rt_1.1.0_ga"

SRCREV = "c0847307e8eca7155402710433fa05eb1d9b985a"
PV = "4.4.19"
...
KERNEL_GIT_URI = "git://github.com/mayqueenEMBEDDED/mq-kernel.git"
